...
export const ARENA = [
  { id: 'a-sum', title: 'Add Two Numbers', tier: 'concept', fn: 'add', prompt: 'Write a function add(a, b) that returns the sum of two numbers.', starter: 'function add(a, b) {\n  // your code here\n}\n', show: [[[2, 3], 5], [[0, 0], 0]], hidden: [[[-1, 1], 0], [[10, 25], 35], [[-4, -6], -10]] },
  { id: 'a-rev', title: 'Reverse a String', tier: 'apply', fn: 'reverse', prompt: 'Write a function reverse(s) that returns the string s backwards.', starter: 'function reverse(s) {\n  // hint: split, reverse, join\n}\n', show: [[['hello'], 'olleh'], [['a'], 'a']], hidden: [[['IT'], 'TI'], [['quest'], 'tseuq'], [[''], '']] },
  { id: 'a-evens', title: 'Count Even Numbers', tier: 'industrial', fn: 'countEvens', prompt: 'Write a function countEvens(arr) that returns how many even numbers are in the array.', starter: 'function countEvens(arr) {\n  // hint: % 2 === 0\n}\n', show: [[[1, 2, 3, 4], 2], [[], 0]], hidden: [[[2, 4, 6], 3], [[1, 3, 5], 0], [[7], 0]] }
];
...
import { LESSONS3, QUESTIONS3 } from './content3.js';
